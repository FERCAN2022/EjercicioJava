...
// pokemons teniendo en cuenta lo siguiente:
...
let total_damage = base_damage + Math.floor(Math.random() * (selectedpokemon.max_damage-1+selectedpokemon.min_damage)+selectedpokemon.min_damage)
